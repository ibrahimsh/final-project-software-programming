...
out = OWL('http://www.ibrahim.com', 'owl_example.owl', 'http://www.ibrahim.com/properties')
out.start()
for n in range(len(names)):
    out.addClass(names[n])
    out.assertEquivalentTriple(names[n], 'hasColor', colors[n],'hairColors')
    out.assertSubClassTriple(names[n], 'hasGender', gender[n],'hc')
out.end()